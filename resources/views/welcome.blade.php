        ...
        <div id="slider1" class="rev_slider"  data-version="5.0">
            ...
            <ul>
                ...
                <li data-transition="zoomout" data-slotamount="10" data-masterspeed="3000" >
                    ...
                    <img src="{{ asset('front/images/resource/slide10.jpg') }}"  alt="slidebg1" class="rev-slidebg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-no-retina />
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="title2">
                    ...
                    <h2>THE CHURCH  <span>WE ARE</span></h2>
                   ...
                   <p>
                    God's love is unconditional and for all of us at The Lovechannels, we receive it with open arms and channel this love by demonstrating and allowing it to flow through us to others around us.
                        ...
                        <ul class="nav nav-tabs" id="myTab">
                            ...
                            <li class="col-md-4 active"><a data-toggle="tab" href="#image1"><img src="{{ asset('front/images/resource/about1.jpg') }}" alt=""></a></li>

                            <li class="col-md-4"><a data-toggle="tab" href="#image2"><img src="{{ asset('front/images/resource/about2.jpg') }}" alt=""></a></li>

                            <li class="col-md-4"><a data-toggle="tab" href="#image3"><img src="{{ asset('front/images/resource/about3.jpg') }}" alt=""></a></li>
                    ...
                    <div class="col-md-6 column">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div id="image1" class="tab-pane fade in active">
                                ...
                                <img src="{{ asset('front/images/resource/about1-big.jpg') }}" alt="">

                            </div>

                            <div id="image2" class="tab-pane fade">

                                <img src="{{ asset('front/images/resource/about2-big.jpg') }}" alt="">

                            </div>

                            <div id="image3" class="tab-pane fade">

                                <img src="{{ asset('front/images/resource/about3-big.jpg') }}" alt="">
                    ...
                    <div class="upcoming-event">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 column">
                                ...
                                <h3><i class="fa fa-bank"></i> {{ $livestream->title }}</h3>

                                <span><i class="fa fa-calendar-o"></i>{{ date_format(date_create($livestream->created_at), 'D jS M, Y') }}</span>

                                <span><i class="fa fa-clock-o"></i> {{ date_format(date_create($livestream->created_at), 'H:i A') }}</span>
                            ...
                            <div class="col-md-6 column" >
                                ...
                                <iframe src="https://www.youtube.com/embed/{{ $livestream->video_id }}" height="280"></iframe>
